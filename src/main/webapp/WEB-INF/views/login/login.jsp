		...
		<div id="content_wrap">
			...
			<div id="login_wrap">				
				<form action='loginAf.do' name='frmFrom' id='_frmFrom' method='post'>					
					...
					<tr>
						<th style="background-color: #eeeeee; color:#3e4fba">아이디</th>
						<td>
							&nbsp;
							<input type="text" id="_userid" name="id"
					...
					<tr>
						<th style="background-color: #eeeeee; color:#3e4fba">패스워드</th>
						<td>
							&nbsp;
							<input type="text" id="_pwd" name="pwd"
							 size="20px" style="border:1px; solid #dddddd" placeholder="pwd">
						</td>
					</tr>						 					 
					<tr>
